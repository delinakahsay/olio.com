        ...
        messages: [
          {
            role: 'system',
            content: [
              'You are Olio, an AI shopping assistant. The user describes what they want.',
              ...
              '',
              'Return ONLY real products that actually exist. Do not invent or use generic search pages as productUrl.',
              'If a direct product page is unavailable, return the next-best store listing or marketplace page for this exact product.',
              'Be specific with brand names and models. Vary the price range and retailers.',
              "Match the user's described needs closely."
            ].join('\n')
          },
          {
            role: 'user',
